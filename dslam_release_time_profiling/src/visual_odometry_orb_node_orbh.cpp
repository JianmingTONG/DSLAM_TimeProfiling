...
{  
    ...
    sensor_msgs::ImagePtr dep_ptr = boost::make_shared<::sensor_msgs::Image>(msg->depth); // &msg->depth;
    // cout << "PRE1" << endl;
    ...
    if(!First_Frame)
    {
        ...
        TF_msg.header.stamp.sec = msg->header.stamp.sec;
        TF_msg.header.stamp.nsec = msg->header.stamp.nsec;
