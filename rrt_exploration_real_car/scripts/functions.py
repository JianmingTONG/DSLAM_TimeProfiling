...
######################## added by jianming
# this place is to initialize the robot service
        self.client = actionlib.SimpleActionClient(
            self.name+'/move_base', MoveBaseAction)
        self.client.wait_for_server()
        
        # self.pose_goal_pub1 = rospy.Publisher('/robot1/move_base_simple/goal', PoseStamped , queue_size=10)
        # self.pose_goal_pub2 = rospy.Publisher('/pub/move_base_simple/goal', PoseStamped , queue_size=10)
########################
...
######################## added by jianming
# this place is send the new robot destination.
    def sendGoal(self, point):
        seq = 0
        # pose_goal = PoseStamped()
        # pose_goal.header.seq = seq
        # seq = seq + 1
        # pose_goal.header.stamp = rospy.Time.now()
        # pose_goal.header.frame_id = "robot1/map"
        # pose_goal.pose.position.x = point[0]
        # pose_goal.pose.position.y = point[1]
        ...
        # self.pose_goal_pub1.publish(pose_goal)
        # self.pose_goal_pub2.publish(pose_goal)

        robot.goal.target_pose.pose.position.x = point[0]
        robot.goal.target_pose.pose.position.y = point[1]
        robot.goal.target_pose.pose.position.z = 0
        robot.goal.target_pose.header.seq = seq
        seq = seq + 1
